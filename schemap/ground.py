...
SYNONYM_MAP = {
    "revenue": ["payments", "amount_cents", "amount", "total"],
    "sales": ["payments", "invoices", "orders"],
    "spend": ["payments", "amount_cents"],
    "money": ["amount_cents", "payments"],
    "billing": ["invoices", "invoice_items", "subscriptions"],
    "customer": ["organizations", "users", "accounts"],
    "client": ["organizations", "users", "accounts"],
    "org": ["organizations"],
